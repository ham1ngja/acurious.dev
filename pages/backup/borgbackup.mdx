...
To install borgbackup, you first need to install Homebrew, which is a macOS packet manager. If you want to read more about brew, I've covered it in [a different article](/macos/brew.mdx).
