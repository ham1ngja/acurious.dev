...
Borgbackup is a deduplicating archiver with compression and encryption. It allows you to store encrypted backups of your data in a space-efficient way. 

## Installation

To install borgbackup on macOS, you first need Homebrew, which is a macOS packet manager. You can read more about `brew` in [this section](/macos/brew).
...
<Callout emoji="💡"> If you wish to add visual separation between groups of paths, you may leave empty lines.</Callout>
